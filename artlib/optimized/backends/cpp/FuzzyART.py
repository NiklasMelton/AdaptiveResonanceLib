...
class FuzzyART(pyFuzzyART):
    """FuzzyART for Clustering. optimized with C++

    This module implements FuzzyART

    FuzzyART is a non-modular clustering model which has been highly
    ...
    Functionally, FuzzyART behaves as a special case of
