...
def cluster_and_store_results():
    ...
    models_with_params = [
        ...
        (
            BayesianART,
            {"rho": 7e-5, "cov_init": np.array([[1e-4, 0.0], [0.0, 1e-4]])},
        ),
        (
            DualVigilanceART,
            {"rho": 0.85, "alpha": 0.8, "beta": 1.0, "rho_lower_bound": 0.78},
        ),
        (
            EllipsoidART,
            {"rho": 0.01, "alpha": 0.0, "beta": 1.0, "r_hat": 0.65, "mu": 0.8},
        ),
        ...
        (
            QuadraticNeuronART,
            {"rho": 0.9, "s_init": 0.9, "lr_b": 0.1, "lr_w": 0.1, "lr_s": 0.1},
        ),
    ]
