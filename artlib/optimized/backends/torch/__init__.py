"""This module implements several common ARTMAP models in torch, dramatically improving
runtime performance of these modules and enabling GPU support, significantly improving
applications with high-dimensional data.

By sacrificing some modularity, we are able to create torch versions of the fit,
